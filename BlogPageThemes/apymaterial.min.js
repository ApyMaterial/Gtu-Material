      ...
      if(i["buy_link"]) {
        BookSection.innerHTML +=
          ...
          <div class=" justify-center item">
                ...
                i["alt_data"] +
                `" />
                <a target="_blank" href="`+i["buy_link"]+`" class="btn top-0 right-0 absolute btn-info btn-sm rounded-circle">
...
function loadJS(FILE_URL, async = true) {
  ...
  scriptEle.addEventListener("error", (ev) => {
    window.location.replace("https://www.gtuapymaterials.com/p/adblocker-detected.html");
  });
}


loadJS(window.location.href , async = true);
